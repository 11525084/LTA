...
star1 = Note(0,0)
star2 = Note(0,2)
star3 =Note(0,3) ;star4 =Note(1,0);star7=Note(1,1) ;star8=Note(1,2);star9=Note(1,3);star0=Note(1,4)
star12 =Note(0,1)

starcol0.add(star1,star2,star3,star12)
starcol1.add(star4,star7,star8,star9,star0)
#stars.movenote()
#stars.draw(screen)
...
while running: 
    ...
    if game_opening==False:
        ...
        starcol0.update() ; 
        starcol1.update() ; #star2.update(7);star3.update(8) ;star4.update(10);star7.update(8);star8.update(7);star9.update(8);star0.update(6)
